...
def csvTojson():
    ...
    #read csv file
    with open("Storage/dictionaries/Creole_Languages.csv", encoding='utf-8') as csvf: 
    ...
    with open("Storage/dictionaries/Creole_Languages.json", 'w', encoding='utf-8') as jsonf: 
